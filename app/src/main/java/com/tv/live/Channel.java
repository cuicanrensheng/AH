...
public class Channel implements Parcelable {
    ...
    public List<String> getHuyaLineLabels() { return huyaLineLabels; }
    public void setHuyaLineLabels(List<String> labels) {
        this.huyaLineLabels = labels != null ? labels : new ArrayList<>();
    }
    public void clearBackupUrls() { backupUrls.clear(); huyaLineLabels.clear(); }
    ...
    public boolean isTogetherWatch() { return isTogetherWatch; }
    public void setTogetherWatch(boolean togetherWatch) { isTogetherWatch = togetherWatch; }
    public int getHuyaRoomId() { return huyaRoomId; }
    public void setHuyaRoomId(int huyaRoomId) { this.huyaRoomId = huyaRoomId; }
    ...
    public static final Creator<Channel> CREATOR = new Creator<Channel>() {
        @Override public Channel createFromParcel(Parcel in) { return new Channel(in); }
        @Override public Channel[] newArray(int size) { return new Channel[size]; }
    };
