...
// ====================================================================
// 所有 import 从 androidx.media3.datasource.*
// 改回对应的 com.google.android.exoplayer2.upstream.* 包名
//
// 【包名迁移对照表（降级版）】
// 新包名 (Media3 1.x)                → 旧包名 (ExoPlayer 2.x)
// androidx.media3.common.C           → com.google.android.exoplayer2.C
// androidx.media3.datasource.BaseDataSource → com.google.android.exoplayer2.upstream.BaseDataSource
