...
public class SettingsDialog extends android.app.Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sw_together_watch.setChecked(sp.getBoolean("together_watch_enable", true));
        ...
        switch (index) {
            ...
            case 3:
                ...
                if (mainActivity != null) {
                    android.util.Log.d("SettingsDialog", "找到MainActivity实例，调用toggleTogetherWatch:" + twChecked);
                    mainActivity.toggleTogetherWatch(twChecked);
                } else {
                    android.util.Log.d("SettingsDialog", "未找到MainActivity实例");
                }
                break;
            case 4:
