...
public class WebServerManager {
    ...
    private String buildConfigPage() {
        ...
        return "<!DOCTYPE html>\n" +
                ...
                "                <input type=\"text\" name=\"live_name\" placeholder=\"添加于 " + new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss", java.util.Locale.ROOT).format(new java.util.Date()) + "\" value=\"\">\n" +
                "            </div>\n" +
                ...
                "            <div class=\"item\">\n" +
                "                <div class=\"item-label\">名称</div>\n" +
                "                <input type=\"text\" name=\"epg_name\" placeholder=\"添加于 " + new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss", java.util.Locale.ROOT).format(new java.util.Date()) + "\">\n" +
                "            </div>\n" +
